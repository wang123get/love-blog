...
class HoerMouse_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        $options = [
            ...
            'exquisite' => "<img src='{$dir}/myCur/normal.cur'><img src='{$dir}/myCur/link.cur'>",
...
JS;
            ...
            case 'fireworks':
                ...
                $js   .= '<script type="text/javascript" src="https://cdn.staticfile.org/animejs/2.2.0/anime.min.js"></script>';
...
//            $js .= '<script>';
//            $js .= <<<JS
//$("body").css("cursor", "url('{$imageDir}/{$mouseType}/normal.cur') 20 20, auto");
